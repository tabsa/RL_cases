...
class trading_env:
    def __init__(self, no_offers, no_trials, offer_file, sample_type=None, no_preferences=2):  # Define parameters of the environment
    ...
    def run(self, trading_agent):  # Run the trading_env
        ...
        target_T = trading_agent.profile_sampling()  # Energy value as Target, where market.offers have reach from [1,...,no_trials]
